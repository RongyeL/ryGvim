...
syn keyword verilogStatement2  inout input output 
syn keyword verilogStatement3  wire reg parameter
...
syn match verilogGlobal2 "`[a-zA-Z0-9_]\+\>"
...
hi def link verilogConditional     Special
...
hi def link verilogStatement       Special
hi def link verilogStatement2      Title
hi def link verilogStatement3      Title

hi def link verilogGlobal          WarningMsg
hi def link verilogGlobal2         Identifier
